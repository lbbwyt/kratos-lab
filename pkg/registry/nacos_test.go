...
func TestRegistry_Register(t *testing.T) {
	sc := []constant.ServerConfig{
		*constant.NewServerConfig("172.19.202.30", 8848),
	}
	...
	tests := []struct {
		...
		},
		{
			name: "withCluster",
			fields: fields{
				registry: nacos.New(client, nacos.WithCluster("test")),
			},
			args: args{
				ctx:     context.Background(),
				service: testServer,
		...
		},
		{
			name: "withGroup",
			fields: fields{
				registry: nacos.New(client, nacos.WithGroup("TEST_GROUP")),
			},
			args: args{
				ctx:     context.Background(),
				service: testServer,
		...
		},
		{
			name: "withWeight",
			fields: fields{
				registry: nacos.New(client, nacos.WithWeight(200)),
			},
			args: args{
				ctx:     context.Background(),
				service: testServer,
		...
		},
		{
			name: "withPrefix",
			fields: fields{
				registry: nacos.New(client, nacos.WithPrefix("test")),
			},
			args: args{
				ctx:     context.Background(),
				service: testServer,
